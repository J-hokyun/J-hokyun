...
### 만드는 데서 끝내지 않고, **배포하고 운영해 본 개발자**

실사용자를 받고, 지표를 보고, 종료 판단까지 직접 내려봤습니다.<br/>
백엔드를 중심으로 **서버 · 앱 · 데이터 분석**까지 한 서비스가 굴러가는 전 과정을 경험했습니다.
...
- 📌 약 3개월 운영 후, **수익 구조의 한계를 지표로 판단해 서비스를 종료**했습니다. 그 과정은 README에 회고로 정리했습니다.
